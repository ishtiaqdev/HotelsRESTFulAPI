...
{
    public class HotelServiceFake : IHotelsServices
    {
        ...
        {
            string filePath = Directory.GetCurrentDirectory().Substring(0, Directory.GetCurrentDirectory().IndexOf("NUnitHotelsApi")) + "HotelsRESTApi\\Files\\task 3 - hotelsrates.json";
